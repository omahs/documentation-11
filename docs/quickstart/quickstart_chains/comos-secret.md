# Secret Network Quick Start

## Goals

The goal of this quick start guide is to adapt the standard starter project in the Secret Network and then begin indexing all transactions coming into on the [SIENNA Single Staking contract](https://www.mintscan.io/secret/account/secret1rgm2m5t530tdzyd99775n6vzumxa5luxcllml4) from the Secret Network.
...
::: tip Note
The final code of this project can be found [here](https://github.com/subquery/cosmos-subql-starter/tree/main/Secret/secret-starter).
:::
