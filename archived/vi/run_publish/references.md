...
::: tip Note
Once the command is executed and the state has been rolled back the specified height, the application will exit. You can then start up the indexer to proceed again from this height.
:::
